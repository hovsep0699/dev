...
import {
  ...
  AdminUlFields,
  ulAdminOptions
} from "@distate/app/src/pages/POA/MCHD_ROOT/presentation/constants/initialValues/AdminFormInitialData";
...
const VariadicFormForULAdmin = ({ handleSubmit, close }: any) => {
  ...
  useEffect(() => {
    switch (formType) {
      case 'ИП':
        setFields(AdminIPFields);
        break;
      case 'ЮЛ':
        setFields(AdminUlFields);
        break;
      case 'ФЛ':      
        setFields(AdminFlFields);
        break;
      default:
        setFields([]);
    }
...
export default VariadicFormForULAdmin;
