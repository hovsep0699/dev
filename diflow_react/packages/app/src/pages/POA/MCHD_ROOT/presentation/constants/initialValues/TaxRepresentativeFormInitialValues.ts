...
export const RepresentativetypeOptions = [
 ...
 export const RepresentativeflFields = [
    {section : 'Доверитель', fields : [
      ...
      { name: 'inn', label: 'ИНН', type: 'input', required: true, placeholder:'Введите ИНН' , title:'Введите 12-значный код' , validation: Yup.string().length(12,'Введите число длиной 12 знаков')},
