...
import { getAddedGroupNaturalEntity } from '../../../../store/actions';

interface Props {
  id: number;
}

/** Фильтр для ФЛ (добавленных) */
export const AddedNaturalEntityFilter = (props: Props) => {
  const { id } = props;
  ...
  const onFilter = () => {
    ...
    dispatch(getAddedGroupNaturalEntity({ ...filterParams, id }));
  };
