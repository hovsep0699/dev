...
const IconCloud = (props: React.SVGProps<SVGSVGElement>) => (
  <svg width={17} height={17} viewBox="0 0 17 17" {...props}>
    <path d="M12.75 4.5c-.578 0-1.146.123-1.691.367A4.728 4.728 0 007.75 3.5a4.702 4.702 0 00-4.397 3.002C1.55 6.428 0 7.923 0 9.75A3.254 3.254 0 003.25 13h9.5C15.093 13 17 11.093 17 8.75S15.093 4.5 12.75 4.5zm0 7.5h-9.5C2.009 12 1 10.991 1 9.75S2.009 7.5 3.25 7.5c.125 0 .244.019.363.038l.435.072.126-.422C4.652 5.58 6.089 4.5 7.75 4.5c1.073 0 2.102.477 2.821 1.307l.265.306.354-.195a3.208 3.208 0 011.56-.418C14.542 5.5 16 6.958 16 8.75S14.542 12 12.75 12z" />
  </svg>
);
