...
import { getAddedGroupLegalEntity } from '../../../../store/actions';

interface Props {
  id: number;
}

/** Фильтр для ЮЛ (добавленных) */
export const AddedLegalEntityFilter = (props: Props) => {
  const { id } = props;
  ...
  const onFilter = () => {
    ...
    dispatch(getAddedGroupLegalEntity({ ...filterParams, id }));
  };
